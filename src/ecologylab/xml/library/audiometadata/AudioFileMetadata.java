 ...
 * 
 */
public class AudioFileMetadata extends ElementState implements
		IMappable<String> {
	@simpl_scalar
	...
	@simpl_scalar
	protected ParsedURL file;

	/**
	 * The unique identifier for this object; time when created + track title
	 * when created.
	 */
	@simpl_scalar
	String id;
	...
	public AudioFileMetadata(ParsedURL audioFileURL) throws ClassCastException,
			IOException, UnsupportedAudioFileException, CannotReadException,
	...
	@Deprecated
	protected void populateMetadataFromFile() throws ClassCastException,
	...
	public void refreshMetadataFromFile() {
		...
		if (propertiesMap.get("duration") != null) {
			...
			System.err
					.println("could not retrieve duration from: " + this.file);
		}
	}
	...
	protected void populateMetadataFromFileUsingJAudioTagger()
			throws ClassCastException, IOException,
			UnsupportedAudioFileException, CannotReadException, TagException,
	...
	private void verifyFileAndLoadJAudioProperties()
